...
\makered{TODO: need to finish putting all my citations in} \\
...
free (\makered{similar to the work done by UCSD PLIDI '14 paper, needs citation}).
\\
...
\begin{itemize}
    ...
    \item \makered{find citation for UCSD PLDI '14 paper}
\end{itemize}
...
\makered{Wrap up, discuss weakness, challenges, ect}
